...
export function ScatterPlotExp() {
    ...
    return (
        <Container  size="lg" m={20}>
            ...
            <Text>Image (1) represents a correlation value (r value) of 0.0, which is the lowest possible correlation value. Values are essentially not related to each other.

                Image (3) represents a correlation value of 0.5. Visually, the points are not as distributed as the plot of r=0.0 to the left. This is a moderate correlation where (x, y) values are somewhat related to each other
